...
public class SysUserServiceImpl implements ISysUserService {
    ...
    @Override
    public AjaxResult registerAdd(String userName, String loginName, String password, String walletPassword, Integer sendCode, Integer registerType) {
        return userService.add(userName,loginName,password,walletPassword,sendCode,registerType);
