...
public class HttpUtil {
	...
	public static void doGet(String url, Map<String, Object> param) {
		// 创建Httpclient对象
	...
	public static void doPost2(String url, Map<String, Object> param) {
		// 创建Httpclient对象
		CloseableHttpClient httpClient = HttpClients.createDefault();
		CloseableHttpResponse response = null;
		String resultString = "";
	...
	public static void quartzPost(String url, Map<String, Object> param,String header,String headerValue) {
		// 创建Httpclient对象
		CloseableHttpClient httpClient = HttpClients.createDefault();
		CloseableHttpResponse response = null;
		String resultString = "";
